...
INSERT INTO "BOARD_LIKE" VALUES(2, 1499); -- 1
INSERT INTO "BOARD_LIKE" VALUES(3, 1498); -- 1
INSERT INTO "BOARD_LIKE" VALUES(10, 1500); 
INSERT INTO "BOARD_LIKE" VALUES(6, 1497); 
...
-- 회원 프로필 이미지 추가
UPDATE "MEMBER" SET 
PROFILE_IMG = '/images/member/profile-sample.gif'
WHERE MEMBER_NO = 1;
...
INSERT INTO BOARD_TYPE VALUES (4,'테스트');
COMMIT;
...
-- /images/member/20231109114948_00003.jpg
