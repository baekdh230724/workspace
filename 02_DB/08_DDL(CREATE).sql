...
--> USER_NO가 다름
--  ORA-00001: 무결성 제약 조건(A230724_BDH.USER_ID_NAME_U)에 위배됩니다
...
--> 기본키 중복으로 오류
-- ORA-00001: 무결성 제약 조건(A230724_BDH.USER_NO_PK)에 위배됩니다

INSERT INTO USER_USED_PK
VALUES(NULL, 'user03', 'pass03', '유관순', '여', '010-9999-3131', 'yoo123@kh.or.kr');
--> 기본키가 NULL 이므로 오류
-- ORA-01400: NULL을 ("A230724_BDH"."USER_USED_PK"."USER_NO") 안에 삽입할 수 없습니다
...
-- ORA-00001: 무결성 제약 조건(A230724_BDH.PK_USERNO_USERID)에 위배됩니다
...
-- ORA-01400: NULL을 ("A230724_BDH"."USER_USED_PK2"."USER_NO") 안에 삽입할 수 없습니다
----------------------------------------------------------------------------------------------------------------
...
-- ORA-02291: 무결성 제약조건(A230724_BDH.GRADE_CODE_FK1)이 위배되었습니다
--            - 부모 키가 없습니다
...
DELETE FROM USER_GRADE 
WHERE GRADE_CODE = 10;
-- ORA-02292: 무결성 제약조건(A230724_BDH.GRADE_CODE_FK1)이 위배되었습니다
-- 			- 자식 레코드가 발견되었습니다
...
-- ORA-02290: 체크 제약조건(A230724_BDH.GENDER_CHECK)이 위배되었습니다
